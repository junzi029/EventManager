...
<body>
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<c:forEach items="${listLocation}" var="location">
				<tr>
					...
					<td><a class="btn btn-default" href="updateLocation/<c:out value="${location.id}" />">編集</a></td>
					<td><a class="btn btn-danger" href="delLocation/<c:out value="${location.id}" />">削除</a></td>
		...
		<p>
			<a href="addLocation" class="btn btn-primary">場所の追加</a>
		</p>
	</div>
